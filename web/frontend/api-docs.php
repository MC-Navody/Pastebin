...
<head>
    ...
    <meta name="description"
          content="API dokumentace pro <?= htmlspecialchars($config->getName()); ?> - Integrujte sdílení logů přímo do svého server panelu nebo hostingového softwaru."/>
...
<main>
    <div class="api-docs-header">
        <div class="api-docs-header-content">
            ...
            <p>Integrujte <strong><?= htmlspecialchars($config->getName()); ?></strong> přímo do svého server panelu,
                hostingového softwaru nebo čehokoliv jiného. Tato platforma byla vytvořena pro vysoce výkonnou
                automatizaci a lze ji snadno integrovat do jakéhokoli existujícího softwaru prostřednictvím našeho HTTP
                API.</p>
        </div>
    </div>
    ...
    <div class="api-docs-section" id="create-log">
        ...
        <div class="api-endpoint">
            <span class="api-method">POST</span> <span
                    class="api-url"><?= htmlspecialchars(URL::getApi()->withPath("/1/log")->toString()); ?></span> <span
                    class="content-type">application/json</span>
        </div>
        <div class="api-note">
            Odesílání obsahu s typem <span class="content-type">application/x-www-form-urlencoded</span> je stále
        ...
        <table class="api-table">
            ...
            <tr>
                ...
                <td class="api-description">
                    ...
                    Omezeno na <?= number_format($config->get(ConfigKey::STORAGE_LIMIT_BYTES) / 1024 / 1024, 2); ?> MiB
                    a <?= number_format($config->get(ConfigKey::STORAGE_LIMIT_LINES)); ?> řádků.
    ...
    "source": "example.org"
        ...
        <table class="api-table">
            ...
            <tr>
                ...
                <td class="api-description">Zda mají být tato metadata viditelná na stránce logu, nebo dostupná pouze
        ...
        <pre class="api-code">
{
    ...
    <div class="api-docs-section" id="get-log-info">
        ...
        <div class="api-endpoint">
            <span class="api-method">GET</span> <span
                    class="api-url"><?= htmlspecialchars(URL::getApi()->toString()); ?>/1/log/[id]</span>
        </div>
        <p>
        ...
        <table class="api-table">
            ...
            <tr>
                ...
                <td class="api-description">Zahrne do odpovědi automaticky detekovanou analýzu (problémy/informace).
                </td>
            </tr>
        </table>
        <h3>Odpovědi</h3>
        ...
        <pre class="api-code">
{
    ...
    <div class="api-docs-section" id="delete-log">
        ...
        <div class="api-endpoint">
            <span class="api-method">DELETE</span> <span
                    class="api-url"><?= htmlspecialchars(URL::getApi()->toString()); ?>/1/log/[id]</span>
        </div>
        ...
        <pre class="api-code">
{
    ...
    <div class="api-docs-section" id="bulk-delete-log">
        ...
        <div class="api-endpoint">
            <span class="api-method">POST</span> <span
                    class="api-url"><?= htmlspecialchars(URL::getApi()->toString()); ?>/1/bulk/log/delete</span>
        </div>
        ...
        <pre class="api-code">
{
    ...
    <div class="api-docs-section" id="get-raw">
        ...
        <div class="api-endpoint">
            <span class="api-method">GET</span> <span
                    class="api-url"><?= htmlspecialchars(URL::getApi()->toString()); ?>/1/raw/[id]</span>
        </div>
        <table class="api-table">
            <tr>
                <th>Pole</th>
            ...
            <tr>
                ...
                <td class="api-type">string</td>
                <td class="api-description">ID log souboru, získané z endpointu pro vložení nebo z URL
                    (<?= htmlspecialchars(URL::getBase()->toString()); ?>/[id]).
                </td>
            </tr>
        </table>
        ...
        <pre class="api-code">
{
    ...
    <div class="api-docs-section" id="get-insights">
        ...
        <div class="api-endpoint">
            <span class="api-method">GET</span> <span
                    class="api-url"><?= htmlspecialchars(URL::getApi()->toString()); ?>/1/insights/[id]</span>
        </div>
        <table class="api-table">
            <tr>
                <th>Pole</th>
        ...
        <pre class="api-code">
{
    ...
    <div class="api-docs-section" id="analyse">
        ...
        <div class="api-endpoint">
            <span class="api-method">POST</span> <span
                    class="api-url"><?= htmlspecialchars(URL::getApi()->withPath("/1/analyse")->toString()); ?></span>
            <span class="content-type">application/x-www-form-urlencoded</span> <span class="content-type">application/json</span>
        </div>
        <table class="api-table">
            <tr>
                <th>Pole</th>
            ...
            <tr>
                <td class="api-field">content</td>
                <td class="api-type">string</td>
                <td class="api-description">Hrubý obsah souboru logu jako řetězec. Maximální délka je 10MiB a 25 tisíc
        ...
        <pre class="api-code">
{
    ...
    <div class="api-docs-section" id="check-limits">
        ...
        <div class="api-endpoint">
            <span class="api-method">GET</span> <span
                    class="api-url"><?= htmlspecialchars(URL::getApi()->withPath("/1/limits")->toString()); ?></span>
        </div>
        <h3>Úspěch <span class="content-type">application/json</span></h3>
        <pre class="api-code">
{
  ...
  "maxLines": 25000
        ...
        <table class="api-table">
            ...
            <tr>
                ...
                <td class="api-type">integer</td>
                <td class="api-description">Maximální délka souboru v bajtech. Logy přesahující tento limit budou
                    zkráceny.
                </td>
            </tr>
            <tr>
    ...
    <div class="api-docs-section" id="check-limits">
        ...
        <div class="api-endpoint">
            <span class="api-method">GET</span> <span
                    class="api-url"><?= htmlspecialchars(URL::getApi()->withPath("/1/filters")->toString()); ?></span>
        </div>
        <h3>Úspěch <span class="content-type">application/json</span></h3>
        <pre class="api-code">
